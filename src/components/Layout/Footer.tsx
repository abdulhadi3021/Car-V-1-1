        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-red-600 font-bold text-xl tracking-wider">MCP</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/auto-shows" className="text-gray-400 hover:text-red-500 transition-colors">
                  Auto Shows
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/car-builds" className="text-gray-400 hover:text-red-500 transition-colors">
                  Car Builds
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 MCP (Motor Car Pakistan). All rights reserved.
            </p>
